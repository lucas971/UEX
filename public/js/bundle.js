...
const InitGUI = (d) => {
    ...
    gui.add(params, 'wave_x').onFinishChange((value) => ocean_uniforms.iResolution.set(value, ocean_uniforms.iResolution.y))
...
const generateCity = (d) => {
    ...
    d.loader.load(
        ...
        (gltf) => {
            ...
            d.scene.getObjectByName('Eau001').material.color = ocean_uniforms.waterCol
            d.scene.getObjectByName('Eau002').material.color = ocean_uniforms.waterCol
