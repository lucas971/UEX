...
const generateCity = (d) => {
    ...
    d.loader.load(
        ...
        (gltf) => {
            ...
            d.scene.getObjectByName('Eau001').material.color.setHex(ocean_uniforms.waterCol)
            d.scene.getObjectByName('Eau002').material.color.setHex(ocean_uniforms.waterCol)
